...
async function meme(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/meme_" + event.senderID + ".png";
   api.setMessageReaction("✅", event.messageID, (err) => {}, true);
const leiamRes = (await axios.get(`${global.alice.api}/meme`)).data;
