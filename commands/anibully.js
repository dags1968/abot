...
async function anibully(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/anibully_" + event.senderID + ".png";
   api.setMessageReaction("✅", event.messageID, (err) => {}, true);
const leiamGet = (await axios.get(`${global.alice.api}/anime?endpoint=bully`, { responseType: 'arraybuffer'})).data;
