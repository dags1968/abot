 const fs = require("fs");
 const canvas = require(`${__dirname}/../alice/wrapper/leiamnashE.js`).makeAnicard;
...
async function anicard(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/anicard_" + event.senderID + ".png";
