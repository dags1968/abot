...
async function milf(event, api, leiam, log, alice) {
try{
const leiamFile = __dirname + "/cache/milf_" + event.senderID + ".png";
...
const leiamGet = (await axios.get(`${global.alice.api}/milf`, { responseType: 'arraybuffer'})).data;
