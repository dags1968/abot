...
async function anicuddle(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/anicuddle_" + event.senderID + ".png";
   api.setMessageReaction("✅", event.messageID, (err) => {}, true);
const leiamGet = (await axios.get(`${global.alice.api}/anime?endpoint=cuddle`, { responseType: 'arraybuffer'})).data;
