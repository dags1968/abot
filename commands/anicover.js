 const fs = require("fs");
 const canvas = require(`${__dirname}/../alice/wrapper/leiamnashE.js`).makeAnicover;
...
async function anicover(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/anicover_" + event.senderID + ".png";
