 const fs = require("fs");
 const canvas = require(`${__dirname}/../alice/wrapper/leiamnashE.js`).makeFbname;
...
async function fbname(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/fbname_" + event.senderID + ".png";
