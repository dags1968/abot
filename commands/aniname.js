 const fs = require("fs");
 const canvas = require(`${__dirname}/../alice/wrapper/leiamnashE.js`).makeAniname;
...
async function aniname(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/aniname_" + event.senderID + ".png";
