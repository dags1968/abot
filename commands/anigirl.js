...
async function anigirl(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/anigirl_" + event.senderID + ".png";
   api.setMessageReaction("✅", event.messageID, (err) => {}, true);
const leiamGet = (await axios.get(`${global.alice.api}/anigirl`, { responseType: 'arraybuffer'})).data;
