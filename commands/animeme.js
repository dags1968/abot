...
async function animeme(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/animeme_" + event.senderID + ".png";
   api.setMessageReaction("✅", event.messageID, (err) => {}, true);
const leiamRes = (await axios.get(`${global.alice.api}/animeme`)).data;
