 const fs = require("fs");
 const canvas = require(`${__dirname}/../alice/wrapper/leiamnashB.js`).makeTrash;
...
async function trash(event, api, leiam, log) {
try{
 const alice = leiam.join(" ");
 const leiamnash = Object.keys(event.mentions);
 const file = __dirname + "/cache/trash_" + event.senderID + ".png";
 const leiamTxt = "i thought you're useless like a garbage sorry my bad";
