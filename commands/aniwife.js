...
async function aniwife(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/aniwife_" + event.senderID + ".png";
   api.setMessageReaction("✅", event.messageID, (err) => {}, true);
const leiamGet = (await axios.get(`${global.alice.api}/anime?endpoint=waifu`, { responseType: 'arraybuffer'})).data;
