...
async function hanime(event, api, leiam, log, alice) {
try{
const leiamFile = __dirname + "/cache/hanime_" + event.senderID + ".png";
...
const leiamGet = (await axios.get(`${global.alice.api}/anime?endpoint=eroneko`, { responseType: 'arraybuffer'})).data;
