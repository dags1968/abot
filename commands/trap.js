...
async function trap(event, api, leiam, log, alice) {
try{
const leiamFile = __dirname + "/cache/trap_" + event.senderID + ".png";
...
const leiamGet = (await axios.get(`${global.alice.api}/anime?endpoint=trap`, { responseType: 'arraybuffer'})).data;
