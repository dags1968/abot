 const fs = require("fs");
 const canvas = require(`${__dirname}/../alice/wrapper/leiamnashE.js`).makeAnimanga;
...
async function animanga(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/animanga_" + event.senderID + ".png";
