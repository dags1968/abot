...
async function femboy(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/femboy_" + event.senderID + ".png";
   api.setMessageReaction("✅", event.messageID, (err) => {}, true);
const leiamGet = (await axios.get(`${global.alice.api}/femboy`, { responseType: 'arraybuffer'})).data;
