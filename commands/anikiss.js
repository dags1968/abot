...
async function anikiss(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/anikiss_" + event.senderID + ".png";
   api.setMessageReaction("✅", event.messageID, (err) => {}, true);
const leiamGet = (await axios.get(`${global.alice.api}/anime?endpoint=kiss`, { responseType: 'arraybuffer'})).data;
