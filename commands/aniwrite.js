 const fs = require("fs");
 const canvas = require(`${__dirname}/../alice/wrapper/leiamnashE.js`).makeAniwrite;
...
async function aniwrite(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/aniwrite_" + event.senderID + ".png";
