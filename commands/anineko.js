...
async function anineko(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/anineko_" + event.senderID + ".png";
   api.setMessageReaction("✅", event.messageID, (err) => {}, true);
const leiamGet = (await axios.get(`${global.alice.api}/anime?endpoint=neko`, { responseType: 'arraybuffer'})).data;
