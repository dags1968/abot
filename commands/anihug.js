...
async function anihug(event, api, leiam, log) {
try{
const leiamFile = __dirname + "/cache/anihug_" + event.senderID + ".png";
   api.setMessageReaction("✅", event.messageID, (err) => {}, true);
const leiamGet = (await axios.get(`${global.alice.api}/anime?endpoint=hug`, { responseType: 'arraybuffer'})).data;
