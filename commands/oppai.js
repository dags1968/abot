...
async function oppai(event, api, leiam, log, alice) {
try{
const leiamFile = __dirname + "/cache/oppai_" + event.senderID + ".png";
...
const leiamGet = (await axios.get(`${global.alice.api}/hentai`, { responseType: 'arraybuffer'})).data;
